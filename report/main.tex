...
% \usepackage{url}  % Basic URLs
\usepackage{hyperref}  % Clickable hyperlinks (recommended)
\hypersetup{
    colorlinks=true,
    linkcolor=blue,
    filecolor=magenta,
...
\makeatletter
\let\ps@IEEEtitlepagestyle\ps@plain
\pagestyle{plain}
...
The code and models developed in this work are available at 
\href{https://github.com/gdoda/ETSP/tree/main}{\textit{https://github.com/gdoda/ETSP/tree/main}} to support reproducibility and future research in this important area.
